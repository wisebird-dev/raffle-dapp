...
$(document).ready(function() {
    window.ethereum.enable().then(function(accounts){
        contractInstance = new web3.eth.Contract(abi, "0xe32B41196A522e2a2cF73313074c51C107543a94", {from: accounts[0]});
        console.log(contractInstance);
        
    });
    
    web3.eth.getBalance("0xe32B41196A522e2a2cF73313074c51C107543a94").then(function(result){
...
/*  Event listener 2
    contractInstance.once('betTaken', {
        filter: {player: '0xe32B41196A522e2a2cF73313074c51C107543a94'}, // for test: player and contract owner are the same
        fromBlock: 7097288
